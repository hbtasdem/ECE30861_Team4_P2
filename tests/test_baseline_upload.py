...
class TestBaselineUpload:
    ...
    def test_upload_model_success(self, client: TestClient, auth_token: str) -> None:
        ...
        assert data["data"]["url"] == "https://huggingface.co/bert-base-uncased/resolve/main/model.safetensors"
    ...
    def test_upload_dataset_success(self, client: TestClient, auth_token: str) -> None:
        ...
        assert data["data"]["url"] == "https://huggingface.co/datasets/wikitext/resolve/main/wikitext-103-v1.zip"
    ...
    def test_upload_response_structure(self, client: TestClient, auth_token: str) -> None:
    ...
    def test_upload_multiple_artifacts(self, client: TestClient, auth_token: str) -> None:
    ...
    def test_upload_same_name_different_ids(self, client: TestClient, auth_token: str) -> None:
        ...
        assert response1.json()["metadata"]["name"] == response2.json()["metadata"]["name"]
        assert id1 != id2
