...
#     @patch("main.ramp_up_time_score.ramp_up_time_score")
#     @patch("main.performance_claims_score.performance_claims_sub_score")
#     @patch("main.dataset_quality_score.dataset_quality_sub_score")
#     @patch("main.available_dataset_code_score.available_dataset_code_score")
#     @patch("main.net_score_calculator.calculate_net_score")
#     def test_calculate_all_scores(
#         self,
...
#         license_path = "main.license_score.license_sub_score"
#         bus_path = "main.bus_factor_score.bus_factor_score"
#         ramp_path = "main.ramp_up_time_score.ramp_up_time_score"
#         perf_path = "main.performance_claims_score.performance_claims_sub_score"
#         dataset_path = "main.dataset_quality_score.dataset_quality_sub_score"
...
#             net_path
#         ) as mock_net:
#             # Set up mock return values - keeping original format
#             mock_license.return_value = 1.0
#             mock_bus.return_value = 0.8
#             mock_ramp.return_value = (0.9, 0.1)
#             mock_perf.return_value = 0.7
