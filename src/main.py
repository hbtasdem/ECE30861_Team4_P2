...
def calculate_all_scores(code_link: str, dataset_link: str, model_link: str,
    ...
    # Code Quality
    # Use same value as dataset and code score
    result["code_quality"] = result["dataset_and_code_score"]
    result["code_quality_latency"] = result["dataset_and_code_score_latency"]
