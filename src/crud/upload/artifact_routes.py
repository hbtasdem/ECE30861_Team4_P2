...
FILE PURPOSE:
Implements 8 BASELINE artifact management endpoints that accept artifacts from URLs
...
ENDPOINTS IMPLEMENTED (8 BASELINE):
...
8. POST /artifact/byRegEx - Query artifacts by regular expression
