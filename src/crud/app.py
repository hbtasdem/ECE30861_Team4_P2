...
if __name__ == "__main__":
    ...
    print("\n🌐 Starting server on http://18.222.3.87:8000")
    print("📄 Frontend: http://18.222.3.87:8000")
    # print("📚 API Docs: http://18.222.3.87:8000/docs")
    print("=" * 60 + "\n")

    uvicorn.run(app, host="18.222.3.87", port=8000)