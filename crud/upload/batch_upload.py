"""Batch and chunked upload endpoints.

Implements:
- POST /api/models/upload-batch: Batch file upload
- POST /api/models/chunked-upload/init: Initiate chunked upload
- POST /api/models/chunked-upload/{session_id}/chunk: Upload chunk
- POST /api/models/chunked-upload/{session_id}/finalize: Finalize chunked upload
- GET /api/models/chunked-upload/{session_id}/progress: Get upload progress
"""
    ...
    **Errors:**
    ...
    try:
        ...
        return ChunkUploadResponse(
            ...
            total_received_bytes=session["total_uploaded_bytes"],
    ...
    try:
        ...
        if session["start_time"]:
            ...
            if elapsed_seconds > 0:
                ...
                upload_speed_mbps = uploaded_mb / elapsed_seconds
        ...
        return UploadProgressResponse(
            ...
            uploaded_bytes=session["total_uploaded_bytes"],
            progress_percent=progress_percent,
